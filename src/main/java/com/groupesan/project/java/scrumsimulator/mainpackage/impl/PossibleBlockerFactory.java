...
public class PossibleBlockerFactory {
    ...
    public PossibleBlocker createNewPossibleBlocker(String name, String description, String status) {
        PossibleBlocker newPB = new PossibleBlocker(name, description, status);
        return newPB;
    }
}
