...
public class PossibleBlockerFactory {
    ...
    public PossibleBlocker createNewPossibleBlocker(String name, String description, String userStoryId) {
        PossibleBlocker newPB = new PossibleBlocker(name, description, userStoryId);
        return newPB;
    }
}
